...
import iitKharagpurLogo from '@/assets/iit_kharagpur.jpg'; // New import for IIT Kharagpur logo
...
const HowItWorks = () => {
  ...
  const logos = [
    ...
    { src: iitKharagpurLogo, alt: "IIT Kharagpur Logo" }, // Added IIT Kharagpur logo
