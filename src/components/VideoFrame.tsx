...
const VideoFrame: React.FC<VideoFrameProps> = ({ className }) => {
  return (
    <div className={cn("relative w-full aspect-video rounded-xl overflow-hidden border-2 border-neutral-800 shadow-2xl shadow-[#7be382]/20", className)}>
      <video 
        autoPlay 
        loop 
        muted 
      ...
      {/* Subtle overlay to match the app's aesthetic */}
