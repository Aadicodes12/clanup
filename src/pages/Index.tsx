  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="mt-8 w-full">
        <Button 
          onClick={() => navigate('/teams')}
          className="bg-orange-500 text-black font-semibold py-3 px-6 rounded-full w-full max-w-[280px] hover:bg-orange-600"
        >
          Explore
        </Button>
      </div>
...
＜dyad-chat-summary>Added orange Explore button below HowItWorksSteps＜/dyad-chat</think><dyad-chat<think>-summary>
</think>-summary>Added orange Explore button</dyad-chat-summary><dyad-chat-summary>
Added orange Explore button
</dyad-chat-summary><dyad-write path="src/pages/Index.tsx" description="Add orange button with black text saying 'Explore' below HowItWorksSteps component.">
"use client";
